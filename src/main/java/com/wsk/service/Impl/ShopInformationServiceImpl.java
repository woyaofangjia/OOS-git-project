...
public class ShopInformationServiceImpl implements ShopInformationService{
    ...
    @Override
    public Integer selectIdByImage(String image) {
    ...
    @Override
    public List<ShopInformation> selectByAuditStatus(int auditStatus) {
        return shopInformationMapper.selectByAuditStatus(auditStatus);
    }
    
    @Override
    public int updateAuditStatus(Integer id, Integer auditStatus) {
        return shopInformationMapper.updateAuditStatus(id, auditStatus);
    }
}
